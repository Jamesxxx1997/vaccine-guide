...
await copyDir('review',(f,e)=>e.isDirectory()?['review/img','review/pages','review/travel-pages'].some(d=>f===d||f.startsWith(d+'/')):
  /\.(jpg|png)$/.test(f)||['review/excerpts.js','review/reference-pages.js','review/reference-tables.js','review/travel-current.js','review/travel-sync-status.js','review/travel-reference-pages.js','review/adverse-effects.js','review/allergens.js'].includes(f));
