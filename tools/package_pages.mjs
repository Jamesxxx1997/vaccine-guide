...
const files=['index.html','csv-viewer.html','csv-viewer.js','csv-viewer.css','reference-ui.js','reference-ui.css','reference-geometry.js','reference-scopes.js','reference-tables.js','travel-data.js','travel-search.js','travel-live.js','travel-search.css','travel-vaccine-guides.js','travel-assessment.js','vaccine-search.js','adverse-effects.js','allergy-guidance.js','clinical.js','human-verify.js','human-verify.css','.nojekyll'];
...
await copyDir('review',(f,e)=>e.isDirectory()?['review/img','review/pages','review/travel-pages'].some(d=>f===d||f.startsWith(d+'/')):
  /\.(jpg|png)$/.test(f)||['review/excerpts.js','review/reference-pages.js','review/reference-tables.js','review/travel-current.js','review/travel-sync-status.js','review/travel-reference-pages.js','review/adverse-effects.js','review/allergens.js','review/clinical.js'].includes(f));
